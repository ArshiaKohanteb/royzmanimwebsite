 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt extends Ys{static getInstance(){return new Rt}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!gs()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return _(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(e,t){this.source=e,this.path=t,this.type=te.LISTEN_COMPLETE}operationForChild(e){return S(this.path)?new ht(this.source,w()):new ht(this.source,R(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class we{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=te.OVERWRITE}operationForChild(e){return S(this.path)?new we(this.source,w(),this.snap.getImmediateChild(e)):new we(this.source,R(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=te.MERGE}operationForChild(e){if(S(this.path)){const t=this.children.subtree(new I(e));return t.isEmpty()?null:t.value?new we(this.source,w(),t.value):new dt(this.source,w(),t)}else return _(C(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new dt(this.source,R(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ic(n){return{filter:n}}function Tc(n,e){_(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),_(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Nc(n,e,t,i,s){const r=new Ec;let o,a;if(t.type===te.OVERWRITE){const h=t;h.source.fromUser?o=wn(n,e,h.path,h.snap,i,s,r):(_(h.source.fromServer,"Unknown source."),a=h.source.tagged||e.serverCache.isFiltered()&&!S(h.path),o=Ot(n,e,h.path,h.snap,i,s,a,r))}else if(t.type===te.MERGE){const h=t;h.source.fromUser?o=kc(n,e,h.path,h.children,i,s,r):(_(h.source.fromServer,"Unknown source."),a=h.source.tagged||e.serverCache.isFiltered(),o=In(n,e,h.path,h.children,i,s,a,r))}else if(t.type===te.ACK_USER_WRITE){const h=t;h.revert?o=Pc(n,e,h.path,i,s,r):o=Ac(n,e,h.path,h.affectedTree,i,s,r)}else if(t.type===te.LISTEN_COMPLETE)o=Dc(n,e,t.path,i,r);else throw ze("Unknown operation type: "+t.type);const l=r.getChanges();return Rc(e,o,l),{viewCache:o,changes:l}}function Rc(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=xn(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(sr(xn(e)))}}function pr(n,e,t,i,s,r){const o=e.eventCache;if(Mt(i,t)!=null)return e;{let a,l;if(S(t))if(_(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const h=Te(e),f=h instanceof v?h:v.EMPTY_NODE,u=qn(i,f);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const h=Ft(i,Te(e));a=n.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const h=C(t);if(h===".priority"){_(me(t)===1,"Can't have a priority with additional path components");const f=o.getNode();l=e.serverCache.getNode();const u=Ki(i,t,f,l);u!=null?a=n.filter.updatePriority(f,u):a=o.getNode()}else{const f=R(t);let u;if(o.isCompleteForChild(h)){l=e.serverCache.getNode();const d=Ki(i,t,o.getNode(),l);d!=null?u=o.getNode().getImmediateChild(h).updateChild(f,d):u=o.getNode().getImmediateChild(h)}else u=Yn(i,h,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),h,u,f,s,r):a=o.getNode()}}return et(e,a,o.isFullyInitialized()||S(t),n.filter.filtersNodes())}}function Ot(n,e,t,i,s,r,o,a){const l=e.serverCache;let h;const f=o?n.filter:n.filter.getIndexedFilter();if(S(t))h=f.updateFullNode(l.getNode(),i,null);else if(f.filtersNodes()&&!l.isFiltered()){const y=l.getNode().updateChild(t,i);h=f.updateFullNode(l.getNode(),y,null)}else{const y=C(t);if(!l.isCompleteForPath(t)&&me(t)>1)return e;const g=R(t),E=l.getNode().getImmediateChild(y).updateChild(g,i);y===".priority"?h=f.updatePriority(l.getNode(),E):h=f.updateChild(l.getNode(),y,E,g,fr,null)}const u=ar(e,h,l.isFullyInitialized()||S(t),f.filtersNodes()),d=new Kn(s,u,r);return pr(n,u,t,s,d,a)}function wn(n,e,t,i,s,r,o){const a=e.eventCache;let l,h;const f=new Kn(s,e,r);if(S(t))h=n.filter.updateFullNode(e.eventCache.getNode(),i,o),l=et(e,h,!0,n.filter.filtersNodes());else{const u=C(t);if(u===".priority")h=n.filter.updatePriority(e.eventCache.getNode(),i),l=et(e,h,a.isFullyInitialized(),a.isFiltered());else{const d=R(t),y=a.getNode().getImmediateChild(u);let g;if(S(d))g=i;else{const p=f.getCompleteChild(u);p!=null?Ks(d)===".priority"&&p.getChild(Js(d)).isEmpty()?g=p:g=p.updateChild(d,i):g=v.EMPTY_NODE}if(y.equals(g))l=e;else{const p=n.filter.updateChild(a.getNode(),u,g,d,f,o);l=et(e,p,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function Qi(n,e){return n.eventCache.isCompleteForChild(e)}function kc(n,e,t,i,s,r,o){let a=e;return i.foreach((l,h)=>{const f=L(t,l);Qi(e,C(f))&&(a=wn(n,a,f,h,s,r,o))}),i.foreach((l,h)=>{const f=L(t,l);Qi(e,C(f))||(a=wn(n,a,f,h,s,r,o))}),a}function Ji(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function In(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,h;S(t)?h=i:h=new k(null).setTree(t,i);const f=e.serverCache.getNode();return h.children.inorderTraversal((u,d)=>{if(f.hasChild(u)){const y=e.serverCache.getNode().getImmediateChild(u),g=Ji(n,y,d);l=Ot(n,l,new I(u),g,s,r,o,a)}}),h.children.inorderTraversal((u,d)=>{const y=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!f.hasChild(u)&&!y){const g=e.serverCache.getNode().getImmediateChild(u),p=Ji(n,g,d);l=Ot(n,l,new I(u),p,s,r,o,a)}}),l}function Ac(n,e,t,i,s,r,o){if(Mt(s,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(S(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return Ot(n,e,t,l.getNode().getChild(t),s,r,a,o);if(S(t)){let h=new k(null);return l.getNode().forEachChild(Me,(f,u)=>{h=h.set(new I(f),u)}),In(n,e,t,h,s,r,a,o)}else return e}else{let h=new k(null);return i.foreach((f,u)=>{const d=L(t,f);l.isCompleteForPath(d)&&(h=h.set(f,l.getNode().getChild(d)))}),In(n,e,t,h,s,r,a,o)}}function Dc(n,e,t,i,s){const r=e.serverCache,o=ar(e,r.getNode(),r.isFullyInitialized()||S(t),r.isFiltered());return pr(n,o,t,i,fr,s)}function Pc(n,e,t,i,s,r){let o;if(Mt(i,t)!=null)return e;{const a=new Kn(i,e,s),l=e.eventCache.getNode();let h;if(S(t)||C(t)===".priority"){let f;if(e.serverCache.isFullyInitialized())f=Ft(i,Te(e));else{const u=e.serverCache.getNode();_(u instanceof v,"serverChildren would be complete if leaf node"),f=qn(i,u)}f=f,h=n.filter.updateFullNode(l,f,r)}else{const f=C(t);let u=Yn(i,f,e.serverCache);u==null&&e.serverCache.isCompleteForChild(f)&&(u=l.getImmediateChild(f)),u!=null?h=n.filter.updateChild(l,f,u,R(t),a,r):e.eventCache.getNode().hasChild(f)?h=n.filter.updateChild(l,f,v.EMPTY_NODE,R(t),a,r):h=l,h.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Ft(i,Te(e)),o.isLeafNode()&&(h=n.filter.updateFullNode(h,o,r)))}return o=e.serverCache.isFullyInitialized()||Mt(i,w())!=null,et(e,h,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return S(this._path)?null:Ks(this._path)}get ref(){return new _e(this._repo,this._path)}get _queryIdentifier(){const e=Ui(this._queryParams),t=Mn(e);return t==="{}"?"default":t}get _queryObject(){return Ui(this._queryParams)}isEqual(e){if(e=ft(e),!(e instanceof ui))return!1;const t=this._repo===e._repo,i=Bn(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+kl(this._path)}}class _e extends ui{constructor(e,t){super(e,t,new $n,!1)}get parent(){const e=Js(this._path);return e===null?null:new _e(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Wt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new I(e),i=Rn(this.ref,e);return new Wt(this._node.getChild(t),i,P)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Wt(s,Rn(this.ref,i),P)))}hasChild(e){const t=new I(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Bh(n,e){return n=ft(n),n._checkNotDeleted("ref"),Rn(n._root,e)}function Rn(n,e){return n=ft(n),C(n._path)===null?mh("child","path",e):Rr("child","path",e),new _e(n._repo,L(n._path,e))}function Wh(n,e){n=ft(n),gh("set",n._path),ph("set",e,n._path);const t=new Ht;return Ih(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class fi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Oh("value",this,new Wt(e.snapshotNode,new _e(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Lh(this,e,t):null}matches(e){return e instanceof fi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function zh(n,e,t,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=t,h=(f,u)=>{os(n._repo,n,a),l(f,u)};h.userCallback=t.userCallback,h.context=t.context,t=h}const o=new jh(t,r||void 0),a=new fi(o);return Nh(n._repo,n,a),()=>os(n._repo,n,a)}function Hh(n,e,t,i){return zh(n,"value",e,t,i)}Wc(_e);Gc(_e);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
